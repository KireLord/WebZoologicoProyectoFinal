...
namespace WebZoologico.Controllers
{
    public class RegistrosController : Controller
    {
        ...
        public RegistrosController(WebZoologicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Registro != null ? 
                          ...
                          Problem("Entity set 'WebZoologicoContext.Registro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebZoologicoContext.Registro'  is null.");
            }
            var registro = await _context.Registro.FindAsync(id);
            if (registro != null)
            {
